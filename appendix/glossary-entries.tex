...
\newacronym[description={\glslink{pskg}{Pre-Shared Key}}]
    {psk}{PSK}{Pre-Shared Key}

\newacronym[description={\glslink{micg}{Message Integrity Code}}]
    {mic}{MIC}{Message Integrity Code}

\newacronym[description={\glslink{p2pg}{Point-to-point}}]
    {p2p}{P2P}{Point-to-point}

\newacronym[description={\glslink{xorg}{Exclusive or}}]
    {xor}{XOR}{Exclusive or}

\newacronym[description={\glslink{hmacg}{Hash-based Message Authentication Code}}]
    {hmac}{HMAC}{Hash-based Message Authentication Code}

\newacronym[description={\glslink{mitmg}{Man in the Middle}}]
...
\newglossaryentry{pskg} {
    name=\glslink{psk}{PSK},
    text=Pre-Shared Key,
    sort=psk,
...
\newglossaryentry{micg} {
    name=\glslink{mic}{MIC},
...
\newglossaryentry{xorg} {
    name=\glslink{xor}{XOR},
    text=Exclusive or,
    sort=xor,
...
\newglossaryentry{mitmg} {
    name=\glslink{mitm}{MitM},
